...
@Entity
public class VoucherStaging extends Base {
	...
	private Integer cancelledFlag = 0;
	...
	private Boolean mtrPushedFlag = false;
	...
	public Boolean getMtrPushedFlag() {
		return mtrPushedFlag;
	}

	public void setMtrPushedFlag(Boolean mtrPushedFlag) {
		this.mtrPushedFlag = mtrPushedFlag;
	}
