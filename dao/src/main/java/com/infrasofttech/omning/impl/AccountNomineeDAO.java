...
import com.infrasofttech.omning.IAccountNomineeDAO;

@Repository("accountNomineeDAO")
public class AccountNomineeDAO extends JpaDAOImpl<Long, AccountNominee> implements
IAccountNomineeDAO {
	@Autowired
