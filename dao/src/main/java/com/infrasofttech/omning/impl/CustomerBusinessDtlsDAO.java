...
@Repository("customerBusinessDtlsDAO")
public class CustomerBusinessDtlsDAO extends
		JpaDAOImpl<Long, CustomerBusinessDtls> implements
		ICustomerBusinessDtlsDAO {
	@Autowired
	...
	public CustomerBusinessDtls getCustomerBusinessDtls(Long id) {
		CustomerBusinessDtls customerBusinessDtls = new CustomerBusinessDtls();
