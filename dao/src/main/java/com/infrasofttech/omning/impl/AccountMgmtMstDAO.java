...
import com.infrasofttech.omning.IAccountMgmtMstDAO;

@Repository("accountMgmtMstDAO")
public class AccountMgmtMstDAO extends JpaDAOImpl<Long, AccountMgmtMst> implements
		IAccountMgmtMstDAO {
	@Autowired
