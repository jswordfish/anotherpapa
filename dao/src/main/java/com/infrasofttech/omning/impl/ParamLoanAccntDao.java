...
@Repository("paramLoanAccntDao")
public class ParamLoanAccntDao extends JpaDAOImpl<Long, ParamLoanAc> implements
		IParamLoanAccntDao {

	private static final Logger logger = Logger.getLogger(ParamLoanAccntDao.class);
