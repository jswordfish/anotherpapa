...
@Repository("roleMenuActionAccessDAO")
public class RoleMenuActionAccessDAO extends JpaDAOImpl<Long, RoleMenuActionAccess> implements
IRoleMenuActionAccessDAO {
	@Autowired
