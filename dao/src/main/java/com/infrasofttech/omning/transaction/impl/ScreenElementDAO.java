...
@Repository("screenElementDAO")
public class ScreenElementDAO extends JpaDAOImpl<Long, ScreenElement>
implements IScreenElementDAO {
private static final Logger logger = Logger.getLogger(ScreenElementDAO.class);	
