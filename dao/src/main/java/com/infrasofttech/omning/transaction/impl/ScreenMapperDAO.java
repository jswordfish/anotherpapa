...
@Repository("screenMapperDAO")
public class ScreenMapperDAO extends JpaDAOImpl<Long, ScreenMapper>
implements IScreenMapperDAO {
private static final Logger logger = Logger.getLogger(ScreenMapperDAO.class);	
