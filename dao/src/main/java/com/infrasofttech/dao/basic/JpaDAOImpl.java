...
public class JpaDAOImpl<K, E> implements JPADAO<E, K> {
	...
	public List<E> findAll() {
		...
		return getEntityManager().createQuery(
				"SELECT h FROM " + entityClass.getName() + " h WHERE isActive=true")
				.getResultList();
	...
	public List<E> find(final int startFrom, final int maxResults) {
		...
		Query q = getEntityManager().createQuery(
				"SELECT h FROM " + entityClass.getName()
						+ " h WHERE isActive=true ORDER BY h.id DESC");
	...
	public List<E> findAllByTenant(String tenantId) {
		...
		return getEntityManager().createQuery(
				"SELECT h FROM " + entityClass.getName() + " h WHERE tenantId=:tenantId AND isActive=true")
	...
	public List<E> findDisabled(String tenantId){
		Query q = (Query)getEntityManager().createQuery(
				"SELECT h FROM " + entityClass.getName()
						...
						+ " ORDER BY h.id DESC").setParameter("tenantId", tenantId);
