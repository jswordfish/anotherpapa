(function(window, document, undefined) {
  ...
  /*  window.onload = function () {
		document.getElementById("newPassword").onchange = confirmPwdCheck;
		document.getElementById("repeatPassword").onchange = confirmPwdCheck;
	};
	...
	function confirmPwdCheck(){
		...
		alert("new password"+document.getElementById("newPassword").value);
