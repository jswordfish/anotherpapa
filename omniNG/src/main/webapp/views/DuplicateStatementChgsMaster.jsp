...
<body bgcolor="#F5F5F3" topmargin="0" onload="startUp();">
	<div align="center">
		...
		<form name="ServiceCharegesMaster" id="ServiceCharegesMasterId"
			action="" method="post">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="60%"><font face="Calibri" size="2"
						...
						color="#CC0000">Duplicate Statement of A/C CHARGES MASTER |
							BROWSE</font></td>
						...
						<td height="21" bgcolor="#CCCCFF" align="center"
							style="border-bottom: 1px dotted #C0C0C0"><b><font
								face="Calibri" size="2"><s:text
										name="global.lbl.upto.transactions" /></font></b></td>
						<td height="21" bgcolor="#CCCCFF"
							style="border-bottom: 1px dotted #C0C0C0"><b><font
								face="Calibri" size="2"><s:text name="global.lbl.charges" /></font></b></td>
						<td height="21" bgcolor="#CCCCFF" align="center"
							style="border-bottom: 1px dotted #C0C0C0"><b><font
				...
				<table id="idTblTxn" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
							style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
							<font face="Calibri" size="2"><s:text
									name="global.lbl.upto.transactions" /></font>
						</td>
						...
						<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
							style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
							<font face="Calibri" size="2"><s:text
									name="global.lbl.only.charge" /></font>
						</td>
						<td colspan="1" width="30%" bgcolor="#FFFFFF" valign="middle"
							align="left"
							style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
							<input type="text" id="idCurrencyCode" name="currencyCode"
							placeholder="0.00" size="10" tabindex="21"
							class="veryLargeTxtLeft"> &nbsp; <input type="button"
							value="<s:text name="global.btn.add"/>" tabindex="26"
							class="button">
						</td>
