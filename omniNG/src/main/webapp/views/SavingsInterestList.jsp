				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								class="bigbtn" value="<s:text name="global.btn.add.interest"/>"
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							size="1" name="D1">
								...
								<option><s:text name="global.val.savings.bank.interest" /></option>
								<option><s:text name="global.val.from.date" /></option>
								<option><s:text name="global.val.to.date" /></option>
								<option><s:text name="global.val.penal.rate" /></option>
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="15%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.savings.bank.interest" /></font></b></td>
								...
								<td width="22%" align="left"><b><font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.penal.rate" /></font></b></td>
