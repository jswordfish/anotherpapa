...
<script language="javascript">
	function addParams() {
		window.location.href = "<s:url value="ParamTDAdd"/>" ;
	}
		...
		<form name="formHome" id="formHomeId">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.lbl.manage.td.params" /></font></td>
			...
			<table id="idTblTxn" width="100%" height="100%" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.params"/>" class="bigbtn"
								onclick="javascript:addParams();"></font> <font face="Calibri"
								size="2">&nbsp;</font>
					</td>
					...
					<td width="10%" align="center"><font face="Calibri" size="2">&nbsp;</font><font
						color="#00CC00"><u><a target="_blank"
								href="SAMPLE_DOWNLOAD_XLS.txt"><font color="#00CC00">PDF</font></a></u></font>&nbsp;&nbsp;<font
						color="#00CC00"><u>CSV</u></font>&nbsp;&nbsp;<font color="#00CC00"><u>XLS</u></font></td>
				</tr>
				<tr height="1" bgcolor="#FFFFFF">
					...
					<td valign="top" align="left" width="100%" colspan="5">
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								valign="middle">
								<td width="16.66%" align="center"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.product.code" /></font></b></td>
								<td width="16.66%" align="center"><font face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
												name="global.lbl.product.name" /></b></font></td>

								<td width="16.66%" align="center"><b><font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.effective.from" /></font></b></td>
								<td width="16.66%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
												name="global.lbl.effective.till" /></b></font>
								<td width="16.66%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;</b></font><b><font face="Calibri"
										size="2"><s:text name="global.lbl.status" /></font></b></td>
								<td width="16.66%" align="center"><font face="Calibri"
							...
							<s:iterator value="params">
								<tr>
									...
									<td width="16.66%" align="center"><s:property value="productcode" /></td>
									<td width="16.66%" align="center"><s:property value="productname" /></td>
									<td width="16.66%" align="center"><s:property value="effectivefrom" /></td>
									<td width="16.66%" align="center"><s:property value="effectivetill" /></td>
									<td width="16.66%" align="center"><s:property value="status" /></td>
									<td width="16.66%" align="center"><s:property value="action" /></td>
									<td width="16.66%" align="center"><a href="">EDIT</a>&nbsp;&nbsp;<a href="">DISABLE</a>
									</td>
								</tr>
							</s:iterator>
							<tr height="1" bgcolor="#FFFFFF">
