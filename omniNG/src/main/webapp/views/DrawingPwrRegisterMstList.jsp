...
function addBranch()
{
	window.location.href ="<s:url value="DrawingPwrRegisterMst"/>";
}
function editBranch()
{
	window.location.href ="<s:url value="DrawingPwrRegisterMst"/>";
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.power.register.details" /></font></td>
					...
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								class="bigbtn"
								value="<s:text name="global.btn.add.power.register.details"/>"
					...
					<td valign="top" align="left" width="100%" colspan="5">
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="20%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.effective.date" /></font></b></td>
								<td width="20%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.expiry.date" /></font></b></td>
