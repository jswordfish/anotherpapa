...
<script language="javascript">
	...
	{
		window.location.href ="<s:url value="AssignNewPassword"/>";
	}
</script>
...
<body bgcolor="#F5F5F3" topmargin="0" onload="startUp();">
	<div align="center">
		...
		<form name="frmAssignNewPassword" id="idfrmAssignNewPassword"
			method="POST" action="AssignNewPassword">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td width="20%"><font face="Calibri" size="2" color="#CC0000">
							&nbsp;&nbsp;&nbsp;</font><font face="Calibri" color="#CC0000"> <s:text
								name="global.lbl.generate.password" />
					</font></td>
			...
			<table id="idTblTxn" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr height="25" bgcolor="#9999FF">
					...
					<td width="30%" align="right"
						...
						<input type="button"
						value="<s:text name="global.menu.generate.password"/>"
						class="bigbtn" onclick="javascript:AssignNewPassword();">
					</td>
