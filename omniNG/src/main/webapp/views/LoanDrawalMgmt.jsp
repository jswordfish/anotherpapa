...
function add()
{
	window.location.href = "<s:url value="LoanDrawalAdd"/>";
}
function edit()
{
	window.location.href = "<s:url value="LoanDrawalAdd"/>";
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.manage.loan.drawals" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.loan.drawal"/>"
								class="bigbtn"
					...
					<td width="50%"><font face="Calibri" size="2"><select
							...
							style="font-family: Calibri; font-size: 10pt; color: #808080; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text name="global.val.memo" />#
								</option>
								<option><s:text name="global.val.sanction" />#
								</option>
					...
					<td valign="top" align="left" width="100%" colspan="5">
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="12%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"> <s:text
												name="global.lbl.customer" />#
									</font></b></td>
								<td width="11%" align="left"><b><font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.loan.appln" />#
									</font></b></td>
								<td width="11%" align="left">&nbsp;<b><font
										face="Calibri" size="2"><s:text name="global.lbl.memo" />
											#</font></b></td>
								<td width="13%" align="left"><font face="Calibri" size="2"><b>&nbsp;<s:text
												name="global.lbl.sanction" /> #
									</b></font>
								<td width="8%" align="left">
									<p align="right">
										<font face="Calibri" size="2"><b>&nbsp;</b></font><b><font
											face="Calibri" size="2"><s:text
													name="global.lbl.loan.amount" />&nbsp;&nbsp; </font></b>
								</td>
