...
<script language="javascript">
	...
	function save() {
		...
		window.location.href ="<s:url value="SavingsInterest"/>";
	}
...
<body bgcolor="#F5F5F3" topmargin="0" onload="startUp();">
	<div align="center">
		...
		<form name="formInterest" id="formInterestId">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.lbl.savings.interest" /></font></td>
			...
			<table id="idTblTxn" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr height="1" bgcolor="#FFFFFF">
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<select size="1" name="trail" id="trail" class="mediumselect">
				...
				<tr>
					...
					<td width="80%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0"
						colspan="3">&nbsp; <select size="1" name="productcode"
						class="mediumselect">
							<option><s:text name="global.val.select" />...
							</option>
					</select> <select size="1" name="slct" class="mediumselect">
							<option><s:text name="global.val.select" />...
							</option>
					</select></td>
				...
				<tr>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<select size="1" name="slct1" class="mediumselect">
							<option><s:text name="global.val.select" />...
							</option>
					</select>
					</td>
				...
				<tr>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						<font face="Calibri" size="2">&nbsp; <s:text
								name="global.lbl.from.account" /></font>
					</td>
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left">&nbsp;
					...
					</select> <select size="1" name="slct4" class="mediumselect">
							<option><s:text name="global.val.sub.account" />...
							</option>
					</select> <input type="text" tabindex="1" id="idTxtMeetingDate18"
						name="fromacnt" size="30" class="mediumTxtLeftAlign">
					</td>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<select size="1" name="D74" class="mediumselect">
							<option><s:text name="global.val.product" />...
							</option>
					</select> <select size="1" name="slct5" class="mediumselect">
							<option><s:text name="global.val.account" />...
							</option>
						...
						name="toacnt" size="30" class="mediumTxtLeftAlign">
					</td>
				</tr>
				...
				<tr>
					...
					<td width="80%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0"
						colspan="3">&nbsp; <select size="1" name="slct6"
						class="mediumselect">
							<option><s:text name="global.val.select" />...
							</option>
				...
				<tr>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						<font face="Calibri" size="2">&nbsp; <s:text
								name="global.lbl.penal.rate" /></font>
					</td>
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<input type="text" tabindex="4" name="penal" size="15"
						class="mediumTxtLeftAlign" value="0.00">
					</td>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						<font face="Calibri" size="2">&nbsp; <s:text
								name="global.lbl.round.off.amount" /></font>
					</td>
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<input type="text" tabindex="4" name="roundoff" size="15"
						class="mediumTxtLeftAlign" value="0.00">
					</td>
				</tr>
				...
				<tr>
					...
					<td width="80%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0"
						colspan="3">&nbsp; <select size="1" name="placntid"
						class="mediumselect">
							<option><s:text name="global.val.product" />...
							</option>
					</select> <select size="1" name="slct8" class="mediumselect">
							<option><s:text name="global.val.account" />...
							</option>
						...
						name="placntidtxt" size="30" class="mediumTxtLeftAlign"></td>
				</tr>
			</table>
			<table>
				<tr>
