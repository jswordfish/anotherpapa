								...
								<td bgcolor="#FFFFFF" width="100%" align="right"
									...
									<table border="0" width="100%" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<p align="right">
													<b><font face="Calibri" size="2">Min. Share
															Amt&nbsp;&nbsp;&nbsp; </font></b>
											</td>
											<td><input tabindex="1" id="idTxtPurposeCode25"
											...
											<td>
												<p align="right">
													<b><font face="Calibri" size="2"> Max. Share
															Amt&nbsp;&nbsp;&nbsp; </font></b>
											</td>
											<td>
												<p align="center">
													<input tabindex="1" id="idTxtPurposeCode29"
														name="txtPurposeCode29" size="15"
														style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; text-align: right; float: left"
														value="7"><font face="Calibri" size="2"> </font>
											</td>
											<td>
												<p align="right">
													<b><font face="Calibri" size="2">Share %&nbsp; </font>
													</b>&nbsp;
											</td>
											<td>
												<p align="center">
						...
						<table width="100%">
							<tr bgcolor="#FF9966" height="25">
								<td width="10%" align="center" bgcolor="#8A8AFF"><b> <font
										face="Calibri" size="2">Minimum Share Amt.</font></b></td>
								<td width="10%" align="center" bgcolor="#8A8AFF"><b> <font
										face="Calibri" size="2">Maximum Share Amt.</font></b></td>
								<td width="10%" align="center" bgcolor="#8A8AFF"><b> <font
										face="Calibri" size="2">Share %</font></b></td>
								<td width="10%" align="center" bgcolor="#8A8AFF"><b> <font
