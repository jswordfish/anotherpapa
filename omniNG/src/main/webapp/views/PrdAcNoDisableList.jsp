...
<br>
	...
	<form name="topForm" action="prdAcNoCRUD.action">
		...
		<button type="button" class="btn btn-primary" onClick="callViewEnabled();"><s:text name="global.btn.show.enabled.account.numbers" /></button>
	</form>
    ...
    <table class="table">
        ...
        <tbody>
        	...
        	<tr class="active">
				...
				<td>
					<a href="prdAcNoEnable.action?accountNumber=<%= prdAcNoMst.getAccountNumber() %>&
												...
												mode=DISABLE"><s:text name="global.ref.enable" /></a>  
				</td>
            </tr>
            <%
				}
