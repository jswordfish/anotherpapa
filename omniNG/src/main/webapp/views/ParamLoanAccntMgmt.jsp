...
<br>
	...
	<form action="ParamCheckingAcAdd.action">
    ...
    <table class="table">
		...
		<%
			List<ParamLoanAc> paramLoanAcz = (List<ParamLoanAc>) request.getAttribute("paramLoanAcz");
		%>
        <tbody>
			<%
				for(ParamLoanAc paramLoanAc : paramLoanAcz) {
			%>
        	<tr class="active">
				...
				<td><a href="ParamLoanAccntEdit.action?id=<%= paramLoanAc.getId() %>">Edit</a>   
					<a href="ParamLoanAccntDisable.action?id=<%= paramLoanAc.getId() %>">Disable</a>  
				</td>
            </tr>
            <%
				}
