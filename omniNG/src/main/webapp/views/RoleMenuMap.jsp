...
<script language="javascript">
	...
	function getRowValues(row) {
		...
		var menuCode = document.getElementById("idMenuCode" + cnt).value;
		fld = menuCode;
...
<body>
	<form id="omniform" method="POST" action="RoleMenuMapAddSave"
		name="nmRoleMenuMap">
		...
		<div>
			<table id="idRoleMenuMap" width="1200" border="0" cellpadding="0"
				...
				<s:sort comparator="#menuMstNameComparator" source="menuMstSet">
				<% int cnt=1; %>
					<s:iterator status="status">
						<tr height="20" id="iRow">
							...
							<s:if test="%{authorizeAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table
										id="idAuthTbl">
										<tr>
											<td><s:checkbox id="authorizeAction%{#status.count}"
													name="authorizeAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{createAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table
										id="idCreateTbl">
										<tr>
											<td><s:checkbox id="createAction%{#status.count}"
													name="createAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{updateAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table
										id="idUpdateTbl">
										<tr>
											<td><s:checkbox id="updateAction%{#status.count}"
													name="updateAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{deleteAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table
										id="idDeleteTbl">
										<tr>
											<td><s:checkbox id="idDeleteAction%{#status.count}"
													name="deleteAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{searchAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="searchAction%{#status.count}"
													name="searchAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{disableAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="disableAction%{#status.count}"
													name="disableAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{downloadAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="downloadAction%{#status.count}"
													name="downloadAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{emailAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="emailAction%{#status.count}"
													name="emailAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{enableAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="enableAction%{#status.count}"
													name="enableAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{printAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="printAction%{#status.count}"
													name="printAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{rejectAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="rejectAction%{#status.count}"
													name="rejectAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{viewAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="viewAction%{#status.count}"
													name="viewAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
							...
							<s:if test="%{smsAction == true}">
								<td align="center" style="border-bottom: 1px dotted #CCCCCC"><table>
										<tr>
											<td><s:checkbox id="smsAction%{#status.count}"
													name="smsAction" disabled="true" /></td>
										</tr>
									</table></td>
							</s:if>
							<s:else>
