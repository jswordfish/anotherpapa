...
function addDeposit()
{
	window.location.href ="<s:url value="AddDeposit"/>";
}
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.lbl.deposit.contract" /></font></td>
					...
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								...
								onclick="javascript:addDeposit();"></font> <font face="Calibri"
								size="2">&nbsp;</font>
					</td>
