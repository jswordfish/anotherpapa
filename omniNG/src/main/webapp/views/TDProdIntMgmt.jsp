...
<script language="javascript">
	function addTDInt() {
		window.location.href = "<s:url value="TDProdIntAdd"/>" ;
	}
	function editTDInt() {
		window.location.href = "<s:url value="TDProdIntAdd"/>" ;
	}
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.manage.td.interest" /></font></td>
					...
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								...
								class="bigbtn" onclick="javascript:addTDInt();"></font> <font
