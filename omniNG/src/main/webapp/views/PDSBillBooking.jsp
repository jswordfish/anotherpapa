...
function addMember()
{
	window.location.href = 'addMember.htm';
}
function editMember()
{
	window.location.href = 'addMember.htm';
		...
		<form name="formHome" id="formHomeId">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000">MANAGE MEMBERS</font></td>
			...
			<table id="idTblTxn" width="100%" height="100%" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								...
								onclick="javascript:addMember();"></font> <font face="Calibri"
								size="2">&nbsp;</font>
					</td>
					...
					<td width="10%" align="center">&nbsp;<font color="#00CC00"><a
							target="_blank" href="SAMPLE_DOWNLOAD_XLS.txt"><font
								color="#00CC00">PDF</font></a></font>&nbsp;&nbsp;<font color="#00CC00"><u>CSV</u></font>&nbsp;&nbsp;<font
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="15%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;Branch Name</font></b></td>
								<td width="20%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;Member
											Code/Name</b></font></td>
								<td width="5%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;Member
											Type</b></font></td>
								<td width="20%" align="left"><b><font face="Calibri"
										size="2">&nbsp;Address</font></b></td>
								<td width="15%" align="left"><font face="Calibri" size="2"><b>&nbsp;Email</b></font>
								<td width="15%" align="left"><font face="Calibri" size="2"><b>&nbsp;Contact
											Details</b></font></td>
							...
							<tr height="25" bgcolor="#DEDEDE" id="idTRTitleSearchrow"
								...
								<td width="20%" align="left"><font face="Calibri" size="2">&nbsp;<input
										...
										style="font-family: Calibri; color: #676767; font-size: 10pt; border: 1px solid #808080; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"
										name="txtT2"></font></td>
								<td width="5%" align="center"><font face="Calibri" size="2">
										<input size="10"
							...
							<tr height="25" bgcolor="#FFFFEE">
								<td width="15%" align="left"
									...
									face="Calibri" size="2">&nbsp;02-Pune Branch</font></td>
								<td width="20%" align="left"
									style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
									<font face="Calibri" size="2">&nbsp;M0043-Mahesh Laddha</font>
								</td>
								...
								<td width="15%" align="left"
									style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0"><font
									face="Calibri" size="2">&nbsp;mahesh.laddha@infrasofttech.com</font></td>
								<td width="15%" align="left"
									style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0"><font
									face="Calibri" size="2">&nbsp;+91.9820594058</font></td>
								<td width="15%" align="center"
									style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
									<font face="Calibri" size="1"><a target="_top"
										href="javascript:editMember();" style="text-decoration: none">EDIT</a>&nbsp;
										<a target="_top" href="addMember.htm"
										style="text-decoration: none">DEL</a>&nbsp; <a target="_top"
										href="addMember.htm" style="text-decoration: none">DISABLE</a></font>
								</td>
							</tr>
							<tr height="25" bgcolor="#FFFFFF">
								<td width="15%" align="left"
								...
								<td width="15%" align="center"
									style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
									<font face="Calibri" size="1"><a target="_top"
										href="addMember.htm" style="text-decoration: none">EDIT</a>&nbsp;
										<a target="_top" href="addMember.htm"
										style="text-decoration: none">DEL</a>&nbsp; <a target="_top"
										href="addMember.htm" style="text-decoration: none">DISABLE</a></font>
								</td>
