...
<script language="javascript">
	function addCountryMaster() {
		window.location.href = "<s:url value="AddCountryMaster"/>";
	}
	function editCountryMaster() {
		window.location.href = "<s:url value="AddCountryMaster"/>";
	}
	function startUp() {
	}
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.menu.country.master" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.country"/>" class="bigbtn"
								onclick="javascript:addCountryMaster();"></font> <font
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							...
							style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text name="global.lbl.country.name" /></option>
								<option><s:text name="global.lbl.region" /></option>
								<option><s:text name="global.lbl.grading" /></option>
								<option><s:text name="global.lbl.country.type" /></option>
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="15%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.country.code" /></font></b></td>
								<td width="22%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"><s:text
												name="global.lbl.country.name" /></font></b></td>
								<td width="10%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
												name="global.lbl.zone" />
									</b></font>
								<td width="12%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text name="global.lbl.region" /></b></font>
								<td width="15%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text name="global.lbl.grading" /></b></font></td>
								<td width="15%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
												name="global.lbl.country.type" /></b></font></td>
							...
							<s:iterator value="countries">
								<tr>
									...
									<td><s:property value="gracePrd" /></td>
									<td><s:property value="countryType" /></td>
								</tr>
