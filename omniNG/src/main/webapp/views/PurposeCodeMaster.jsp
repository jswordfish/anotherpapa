...
function addPurposeCodeMaster()
{
	window.location.href ="<s:url value="AddPurposeCodeMaster"/>";
}

function editPurposeCodeMaster()
{
	window.location.href = "<s:url value="AddPurposeCodeMaster"/>";
}
function startUp(){
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.menu.purposeCode.master" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.purposeCode.master"/>"
								class="bigbtn" onclick="javascript:addPurposeCodeMaster();"></font>
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							...
							style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text name="global.lbl.purpose.code" /></option>
								<option><s:text name="global.lbl.purpose.code.description" /></option>
					...
					<td valign="top" align="left" width="100%" colspan="5">
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="10%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text name="global.lbl.purpose.code.description" /></font></b></td>
						...
						<s:iterator value="purposeCodes">
								<tr>
									<td><s:hidden value="id" /></td>
									<td><s:property value="purposeCode" /></td>
									<td><s:property value="purposeDesc" /></td>
								</tr>
