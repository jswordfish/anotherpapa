...
<body bgcolor="#F5F5F3" topmargin="0" onload="startUp();">
	...
	<div align="center">
		...
		<form name="cashEntryMgmt" id="cashEntryMgmtId" action="Entry">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.cash.entry.manager" /></font></td>
			...
			<table id="idTblTxn" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						...
						class="mediumselect">
							<option><s:text name="global.val.cash.cr" /></option>
							<option><s:text name="global.val.cash.dr" /></option>
							<option><s:text name="global.val.cash.den" /></option>
							<option><s:text name="global.val.lcash7" /></option>
					</select>
					</td>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;<font
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						...
						type="text" id="idTransId" name="transId" size="10" tabindex="2">
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<input type="text" name="totalTrans" size="10" tabindex="3"
				...
				<tr>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;&nbsp;<input
						type="text" name="debitCount" size="10" tabindex="4"
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;<input
						type="text" name="debitAmount" size="15" tabindex="5"
				...
				<tr>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;&nbsp;<input
						type="text" name="creditCount" size="10" tabindex="6"
						class="smallTxtLeftAlign"></td>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						&nbsp;<font face="Calibri" size="2"><s:text
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;<input
						type="text" name="creditAmount" size="15" tabindex="7"
						class="mediumTxtLeftAlign"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
						<input type="text" name="mainScrollNum" size="10" tabindex="8">
						&nbsp;
					</td>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
					...
					<td width="30%" bgcolor="#FFFFFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;<input
						type="text" name="transAmount" size="15" tabindex="9"
						class="mediumTxtLeftAlign"></td>
				</tr>
				<tr>
				...
				<tr height="25" bgcolor="#9999FF">
					...
					<td width="30%" align="right"
						...
						<input tabindex="10" type="submit"
						value="<s:text name="global.btn.add"/>" class="button">
					...
					<td width="20%" align="left"
						...
						type="submit" value="<s:text name="global.btn.denomination"/>"
						tabindex="12" class="bigbtn">
					</td>
