...
<script language="javascript">
	function add() {
		window.location.href = "<s:url value="PerAccidentInsuCropLoanAdd"/>";
	}
	function edit() {
		window.location.href = "<s:url value="PerAccidentInsuCropLoanAdd"/>";
	}
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.per.accident.insurance" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.insurance"/>" class="bigbtn"
								onclick="javascript:add();"></font> <font face="Calibri"
								size="2">&nbsp;</font>
					</td>
					<td width="50%"><font face="Calibri" size="2"> <select
							...
							style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text name="global.val.crop.type" /></option>
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="10%" align="center"><b><font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.term.loan.type" /></font></b></td>
								<td width="10%" align="center"><b> <font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.purpose.code" /></font></b></td>
								<td width="10%" align="center"><b> <font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.crop.type" /></font></b></td>
								<td width="10%" align="center"><b> <font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.bank" /> %
									</font></b></td>
								<td width="10%" align="center"><b> <font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.farmer" /> %
									</font></b></td>
								<td width="20%" align="center"><b> <font face="Calibri"
										size="2">&nbsp;<s:text
												name="global.lbl.bank.contribution" /></font></b></td>
								<td width="10%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
												name="global.lbl.effective.from" /></b></font>
								<td width="10%" align="center"><font face="Calibri"
									size="2"><b><s:text name="global.lbl.effective.to" /></b></font></td>
								<td width="10%" align="center"><font face="Calibri"
