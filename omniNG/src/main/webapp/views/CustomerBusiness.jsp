...
<br>
	...
	<form action="addCustomerBusiness.action">
	<button type="submit" class="btn btn-primary">Add Customer Business</button>
	</form>
    ...
    <table class="table">
        ...
        <tbody>
        	...
        	<tr class="active">
				...
				<td><a href="customerCRUD.action?id=<%= kycDoc.getId()%>">Edit</a>   
