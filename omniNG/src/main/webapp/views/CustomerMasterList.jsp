...
function addBranch()
{
	window.location.href ="<s:url value="CustomerMaster"/>";
}
function editBranch()
{
	window.location.href ="<s:url value="CustomerMaster"/>";
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.customer.master.information" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								class="bigbtn"
								value="<s:text name="global.btn.add.customer.info"/>"
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							size="1" name="D1">
								...
								<option><s:text name="global.val.name" />...
								</option>
								<option><s:text name="global.val.customer.number" /></option>
								<option><s:text name="global.val.mobile" /></option>
								<option><s:text name="global.val.PAN.number" /></option>
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="30%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.customer.number" /></font></b></td>
								<td width="30%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.mobile.number" /></font></b></td>
								<td width="10%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"><s:text
												name="global.lbl.gender" /></font></b></td>
								<td width="5%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
												name="global.lbl.PAN.number" />
									</b></font>
