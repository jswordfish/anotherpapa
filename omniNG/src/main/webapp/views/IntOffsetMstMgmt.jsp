...
<script language="javascript">
	function addIntOffset() {
		window.location.href = "<s:url value="IntOffsetMstAdd"/>";
	}
	function editIntOffset() {
		window.location.href = "<s:url value="IntOffsetMstAdd"/>";
	}
	function startUp() {
	}
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.manage.interest.offset" /></font></td>
					...
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.interest.offset"/>"
								class="bigbtn" onclick="javascript:addIntOffset();"></font> <font
					...
					<td valign="top" align="left" width="100%" colspan="5">
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="28%" align="left" colspan="2"><font
									face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
												name="global.lbl.product.name" />&nbsp;
									</b></font></td>
								<td width="19%" align="left"><b><font face="Calibri"
										size="2">&nbsp; <s:text name="global.lbl.account.type" /></font></b></td>
								<td width="13%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
