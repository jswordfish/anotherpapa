...
function addCancelBeforeFunding()
{
	window.location.href ="<s:url value="AddCancelBeforeFunding"/>";
}
function editCancelBeforeFunding()
{
	window.location.href = "<s:url value="AddCancelBeforeFunding"/>";
}
function startUp(){
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.menu.cancel.before.funding" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.deposit"/>" class="bigbtn"
								onclick="javascript:addCancelBeforeFunding();"></font> <font
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							...
							style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text name="global.lbl.certificate.date" /></option>
								<option><s:text name="global.lbl.deposit.amount" /></option>
								<option><s:text name="global.lbl.status" /></option>
								<option><s:text name="global.lbl.maturity.date" /></option>
