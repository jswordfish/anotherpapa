...
<script src='http://codepen.io/assets/editor/live/css_live_reload_init.js'></script>
	...
	function callViewEnabled(){
		document.forms["holidayBranchMapListForm"].action = "holidayBranchMapList.action";
...
<br>
	...
	<form  name="holidayBranchMapListForm" method="post">
		...
		<button type="button" class="btn btn-primary" onClick="callViewEnabled();"><s:text name="global.btn.show.enabled.holiday.branches" /></button>
	</form>
        ...
        <tbody>
        	...
        	<tr class="active">
               <td><%= holidayBranchMap.getBranchCode() %></td>
				...
				<td><a href="holidayBranchMapEnable.action?holidayCode=<%= holidayBranchMap.getHolidayCode() %>
														  &branchCode=<%= holidayBranchMap.getBranchCode() %>
														  &holidayDate=<%= holidayBranchMap.getHolidayDate() %>&mode=ENABLE"><s:text name="global.ref.enable" /></a>  
				</td>				
            </tr>
            <%
				}
