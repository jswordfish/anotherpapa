...
function addTdDataEntry()
{
	window.location.href ="<s:url value="AddTdDataEntry"/>";
}
function editTdDataEntry()
{
	window.location.href = "<s:url value="AddTdDataEntry"/>";
}
function startUp(){
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="40%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.lbl.deposit.contract.modify.transfer.accounct" /></font></td>
					...
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								...
								onclick="javascript:addTdDataEntry();"></font> <font
