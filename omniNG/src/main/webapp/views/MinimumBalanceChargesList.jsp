...
function addMinimumBalanceCharges()
{
	window.location.href ="<s:url value="MinimumBalanceCharges"/>";
}
function editMinimumBalanceCharges()
{
	window.location.href = "<s:url value="MinimumBalanceCharges"/>";
}
function startUp(){
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="40%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.menu.minimum.balance.charges" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.minimum.charges.balence"/>"
								class="bigbtn" onclick="javascript:addMinimumBalanceCharges();"></font>
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							...
							style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text name="global.lbl.effective.date" /></option>
								<option><s:text
										name="global.lbl.frequency.of.application" /></option>
							...
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="20%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"><s:text
												name="global.lbl.account.type.customer.category" /></font></b></td>
								...
								<td width="20%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
												name="global.lbl.frequency.of.application" /></b></font>
								<td width="20%" align="center"><font face="Calibri"
