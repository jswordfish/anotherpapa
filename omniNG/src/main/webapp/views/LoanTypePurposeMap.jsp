...
function addVendor()
{
	window.location.href = "<s:url value="LoanTypePurposeMapAdd"/>";
}
function editVendor()
{
	window.location.href = "<s:url value="LaonTypePurposeMapAdd"/>";
}
function startUp(){
}
</script>
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.lbl.manage.vendors" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.vendors"/>" class="bigbtn"
					...
					<td width="50%"><font face="Calibri" size="2"><select
							name="D1" class="dropDown">
								...
								<option><s:text name="global.val.vendor.code" /></option>
								<option selected><s:text name="global.val.vendor.name" /></option>
								<option><s:text name="global.val.address" /></option>
