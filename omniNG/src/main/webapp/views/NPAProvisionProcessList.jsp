...
function addBranch()
{
	window.location.href ="<s:url value="NPAProvisionProcess"/>";
}
function editBranch()
{
	window.location.href ="<s:url value="NPAProvisionProcess"/>";
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								class="bigbtn"
								value="<s:text name="global.btn.add.NPA.provision"/>"
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							size="1" name="D1">
								...
								<option><s:text name="global.val.batch.code" /></option>
					...
					<td valign="top" align="left" width="100%" colspan="5">
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="25%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.batch.code" /></font></b></td>
								<td width="25%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text name="global.lbl.due.date" /></font></b></td>
