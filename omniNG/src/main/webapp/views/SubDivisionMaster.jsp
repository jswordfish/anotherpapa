...
function addSubDivisionMaster()
{
	window.location.href ="<s:url value="AddSubDivisionMaster"/>";
}
function editSubDivisionMaster()
{
	window.location.href = "<s:url value="AddSubDivisionMaster"/>";
}
function startUp(){
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text
								name="global.menu.sub.division.master" /></font></td>
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.sub.division.master"/>"
								class="bigbtn" onclick="javascript:addSubDivisionMaster();"></font>
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							...
							style="font-family: Calibri; font-size: 10pt; color: #000000; border: 1px solid #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
								...
								<option><s:text
										name="global.lbl.sub.division.master.code" /></option>

								<option><s:text
										name="global.lbl.sub.division.master.name" /></option>
								<option><s:text name="global.lbl.state.description" /></option>
								<option><s:text name="global.lbl.district.description" /></option>
								<option><s:text name="global.lbl.local.or.foreign" /></option>
								<option><s:text name="global.lbl.country.code" /></option>
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="15%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.sub.division.master.code" /></font></b></td>
								<td width="15%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"><s:text
												name="global.lbl.sub.division.master.name" /></font></b></td>
								<td width="15%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"><s:text
												name="global.lbl.state.description" /></font></b></td>
								<td width="10%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
												name="global.lbl.district.description" />
									</b></font>
								<td width="12%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
												name="global.lbl.local.or.foreign" /></b></font>
								<td width="15%" align="center"><font face="Calibri"
									size="2"><b>&nbsp;<s:text
												name="global.lbl.country.code" /></b></font></td>
