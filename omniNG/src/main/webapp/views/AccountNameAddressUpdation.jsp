...
<body bgcolor="#F5F5F3" topmargin="0" onload="startUp();">
	<div align="center">
		...
		<form name="frmCustomerLevelAccountDetails"
			id="idfrmCustomerLevelAccountDetails" method="POST"
			action="CustomerLevelAccountDetails">
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td width="30%"><font face="Calibri" size="2" color="#CC0000">
							...
							Account Name/Updation Process | MODIFY </font></td>
			...
			<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						...
						&nbsp;<font face="Calibri" size="2"><s:text
								name="global.lbl.skip.closed.account" /></font>
					</td>
				...
				<tr>
					...
					<td colspan="3" width="30%" bgcolor="#FFFFFF" valign="middle"
						...
						type="submit" value="<s:text name="global.ref.view"/>"
						class="button">
					</td>
					<td width="20%" bgcolor="#FFFFFF" valign="top" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;</td>
				...
				<tr>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						&nbsp;<font face="Calibri" size="2"><s:text
								name="global.lbl.update.name" /></font>
					</td>
					<td colspan="3" required width="30%" bgcolor="#FFFFFF"
						valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
				...
				<tr>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						&nbsp;<font face="Calibri" size="2"><s:text
								name="global.lbl.update.address" /></font>
					</td>
					<td colspan="3" required width="30%" bgcolor="#FFFFFF"
						valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
				...
				<tr>
					<td width="20%" bgcolor="#CCCCFF" valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">
						&nbsp;<font face="Calibri" size="2"><s:text
								name="global.lbl.address.type" /></font>
					</td>
					<td colspan="3" required width="30%" bgcolor="#FFFFFF"
						valign="middle" align="left"
						style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px dotted #C0C0C0">&nbsp;
				...
				<tr height="35" bgcolor="#0000FF">
					<td width="25%" valign="middle" colspan="4" bgcolor="#0000FF"
						...
						face="Calibri" size="2" color="#FFFFFF"><b>Possible
								Accounts</b></font>
					</td>
				</tr>
				...
				<tr height="25" bgcolor="#FF9966" id="idTRTitlerow" valign="middle">
					...
					<td width="30%" align="center"><font face="Calibri" size="2"><b>&nbsp;<s:text
									name="global.lbl.account" /></b></font></td>
					<td width="40%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
				...
				<tr height="25" bgcolor="#9999FF">
					...
					<td width="30%" align="right"
						...
						class="button"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
						type="submit" value="<s:text name="global.btn.reset"/>"
						class="button">
