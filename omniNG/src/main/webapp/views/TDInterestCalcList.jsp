...
function addBranch()
{
	window.location.href ="<s:url value="TDInterestCalc"/>";
}
function editBranch()
{
	window.location.href = "<s:url value="TDInterestCalc"/>";
				...
				<tr height="25" bgcolor="#FFFFff">
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								class="bigbtn"
								value="<s:text name="global.btn.add.TD.Interest"/>"
					...
					<td width="50%"><font face="Calibri" size="2"> <select
							size="1" name="D1">
								...
								<option><s:text name="global.val.product.code" />...
								</option>
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="30%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.from.account.number" /></font></b></td>
								<td width="30%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text
												name="global.lbl.to.account.number" /></font></b></td>
