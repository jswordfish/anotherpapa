...
<script language="javascript">
	function add() {
		window.location.href = "<s:url value="LoanLimitAdd"/>";
	}
	function edit() {
		window.location.href = "<s:url value="LoanLimitAdd"/>";
	}
			...
			<table id="idTblTitle" width="100%" height="26" cellpadding="0"
				...
				<tr height="25" bgcolor="#FFFFFF">
					<td colspan="1" width="20%"><font face="Calibri" size="2"
						...
						color="#CC0000"><s:text name="global.lbl.manage.loan.limit" /></font></td>
					...
					<td width="20%">
						<p align="left">
							<font face="Calibri" size="2">&nbsp; <input type="button"
								value="<s:text name="global.btn.add.loan.limit"/>"
						...
						<table width="100%" id="idListTbl" cellspacing="1" cellpadding="0">
							<tr height="25" bgcolor="#FF9966" id="idTRTitlerow"
								...
								<td width="15%" align="left"><b><font face="Calibri"
										size="2">&nbsp;&nbsp;<s:text name="global.lbl.customer" />
											#
									</font></b></td>
								<td width="20%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;<s:text
												name="global.lbl.customer.name" /></b></font></td>
								<td width="5%" align="left"><font face="Calibri" size="2"><b>&nbsp;&nbsp;</b></font><b><font
										face="Calibri" size="2"><s:text name="global.lbl.memo" />
											#</font></b></td>
								<td width="22%" align="left"><b><font face="Calibri"
										size="2">&nbsp;<s:text name="global.lbl.sanction" /> #
									</font></b></td>
								<td width="11%" align="left"><font face="Calibri" size="2"><b>&nbsp;<s:text
												name="global.lbl.purpose.code" /></b></font>
								<td width="11%" align="left"><font face="Calibri" size="2"><b>&nbsp;</b></font><b><font
