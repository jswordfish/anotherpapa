...
<br>
	...
	<button type="button" class="btn btn-primary" onClick="callViewEnabled();"><s:text name="global.btn." />Show Enabled A/c Config</button>
	</form>
    ...
    <table class="table">
        ...
        <tbody>
        	...
        	<tr class="active">
				...
				<td>   
					<a href="prdAcNoConfigEnable.action?productCode=<%= prdAcNumberConfig.getProductCode() %>&moduleCode=<%= prdAcNumberConfig.getModuleCode() %>&mode=DISABLE"><s:text name="global.ref.enable" /></a>  
				</td>
            </tr>
            <%
				}
