...
public class ParamLoanAcDisableAction extends ActionSupport implements
ServletRequestAware{
	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger
			.getLogger(ParamLoanAcDisableAction.class);
	...
	public String execute() throws Exception {
		try {
			if (request.getSession() == null) {
				...
				ParamLoanAc entity= paramsLoanService.getParamLoanByUniqueComposite(tenantId, moduleCode, productCode, branchCode1,effFromDate);
				if(null != entity){
