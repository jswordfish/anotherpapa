...
public class PrdAcNumberConfigDisableAction extends ActionSupport implements
		ServletRequestAware {
	...
	public String execute() throws ParseException {
		...
		try {
			if (request.getSession() == null) {
				...
				prdAcNumberConfig = prdAcNoConfigService.disablePrdAcNo(tenantId, moduleCode, productCode);
