...
public class LoanInterestMstDisableAction extends ActionSupport implements  ServletRequestAware { 

	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger.getLogger(LoanInterestMstDisableAction.class);
	...
	public String execute() throws Exception {
		try{
			...
			{ 
				...
				GLMst glMst = glMstService.disableGL(tenantId, glCode,fyCode);
