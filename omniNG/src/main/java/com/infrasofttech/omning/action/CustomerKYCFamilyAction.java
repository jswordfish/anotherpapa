...
public class CustomerKYCFamilyAction extends ActionSupport implements ServletRequestAware {

	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger.getLogger(CustomerKYCFamilyAction.class);
	...
	public String execute() throws Exception {
		try{
			...
			{ 
				...
				request.setAttribute("customerKYCFamily", customerMst.getCustomerKYCFamilies());
