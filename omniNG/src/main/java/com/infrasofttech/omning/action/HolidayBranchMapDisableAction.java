 ...
 * 
 */
public class HolidayBranchMapDisableAction extends ActionSupport implements
		ServletRequestAware {

	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger
			.getLogger(HolidayBranchMapDisableAction.class);
		...
		try {
			if (request.getSession(false) == null) {
				...
				holidayBranchMap = holidayBranchMapService
						.disableHolidayBranchMap(tenantId, branchCode,
