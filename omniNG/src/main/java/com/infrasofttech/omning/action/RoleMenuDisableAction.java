 ...
 *
 */
public class RoleMenuDisableAction extends ActionSupport implements ModelDriven<RoleMenuActionAccess>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						RoleMenuActionAccess roleMenuActionAccess = (RoleMenuActionAccess) roleMenuActionAccessService.find(id);
						roleMenuActionAccess.setEnableAction(MENUACTIONSTATUS.DISABLED);
