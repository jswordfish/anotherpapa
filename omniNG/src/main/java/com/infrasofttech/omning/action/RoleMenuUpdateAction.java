 ...
 *
 */
public class RoleMenuUpdateAction extends ActionSupport implements ModelDriven<RoleMenuActionAccess>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						roleMenuActionAccessService.saveOrUpdate(getModel());
