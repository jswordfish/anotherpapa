...
public class ParamLoanAcDisableList extends ActionSupport implements
ServletRequestAware {
	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger
			.getLogger(ParamLoanAcDisableList.class);
	...
	public String execute() throws Exception {
		try {
			if (request.getSession() == null) {
				...
				paramLoanAcs = paramsLoanService.findDisabled(tenantId);
