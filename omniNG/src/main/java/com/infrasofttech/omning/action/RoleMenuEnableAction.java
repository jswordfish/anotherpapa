 ...
 *
 */
public class RoleMenuEnableAction extends ActionSupport implements ModelDriven<T>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						roleMenuActionAccess.setEnableAction(MENUACTIONSTATUS.ACTIVE);
