 ...
 *
 */
public class ParamLoanAcEditAction extends ActionSupport implements ModelDriven<ParamLoanAc>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						ParamsLoanService paramsLoanService = (ParamsLoanService) SpringUtil.getSpringUtil().getService("paramsLoanAcService");
						long id = Long.parseLong(request.getParameter("id"));
						paramLoanAc =  (ParamLoanAc) paramsLoanService.find(id);
