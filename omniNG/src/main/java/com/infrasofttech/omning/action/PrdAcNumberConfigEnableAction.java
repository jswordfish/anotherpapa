...
public class PrdAcNumberConfigEnableAction extends ActionSupport implements
		ServletRequestAware {

	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger
			.getLogger(PrdAcNumberConfigEnableAction.class);
	...
	public String execute() throws ParseException {
		...
		try {
			if (request.getSession() == null) {
				...
				prdAcNumberConfig = prdAcNoConfigService.enablePrdAcNo(tenantId, moduleCode, productCode);
