 ...
 *
 */
public class ProductEnableAction extends ActionSupport implements  ServletRequestAware {

	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger.getLogger(ProductEnableAction.class);
	...
	public String execute() throws Exception {
		try{
			...
			{ 
				...
				System.out.println("ProductEnableAction.execute()");
				...
				if(request.getParameter("productCode") != null && request.getParameter("moduleCode") != null){
					try{
						...
						System.out.println("ProductEnableAction CATCH");
						e.printStackTrace();
					}
				}
