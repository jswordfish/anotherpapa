 ...
 *
 */
public class ParamLoanAcUpdateAction extends ActionSupport implements ModelDriven<ParamLoanAc>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						paramsLoanService.saveOrUpdate(getModel());
