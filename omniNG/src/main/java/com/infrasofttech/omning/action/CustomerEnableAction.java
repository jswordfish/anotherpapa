 ...
 *
 */
public class CustomerEnableAction extends ActionSupport implements ModelDriven<T>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						CustomerMst customerMst = (CustomerMst) customerService.find(custId);
						customerMst.setIsActive(true);
