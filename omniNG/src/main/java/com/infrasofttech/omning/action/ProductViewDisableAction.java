...
public class ProductViewDisableAction extends ActionSupport implements  ServletRequestAware{ 

	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger.getLogger(ProductViewDisableAction.class);
	...
	public String execute() throws Exception {
		try{
			...
			{ 
				...
				productMstList = productMstService.findDisabled(tenantId);
				System.out.println("Disabl product  : "+ productMstList.size());
	...
	public List<ProductMst> getProductMstList() {
	...
	public void setProductMstList(List<ProductMst> productMstList) {
		this.productMstList = productMstList;
	}
