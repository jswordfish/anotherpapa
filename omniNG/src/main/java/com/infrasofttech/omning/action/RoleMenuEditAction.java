 ...
 *
 */
public class RoleMenuEditAction extends ActionSupport implements ModelDriven<RoleMenuActionAccess>, ServletRequestAware {
			...
			{ 
				...
				if(vTokenReq == null || vTokenSession == null){
					...
					if(!vTokenReq.equals(vTokenSession)){ 
						...
						roleMenuActionAccess = (RoleMenuActionAccess) roleMenuActionAccessService.find(id);
