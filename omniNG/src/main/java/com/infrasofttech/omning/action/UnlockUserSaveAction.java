...
public class UnlockUserSaveAction extends ActionSupport implements ServletRequestAware {
	...
	public String execute() throws Exception {
		try{
			...
			{ 
				...
				String userLoginId = request.getParameter("unlockUserLoginId");
				if(null != userLoginId){
					if(userLoginId.equalsIgnoreCase(loginId)){
						errMsg = "Cannot Unlock Own User";
						...
						user = userMstService.unLockUser(tenantId, userLoginId);
