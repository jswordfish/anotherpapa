...
public class ParamChkDisableAction extends ActionSupport implements  ServletRequestAware {
	private static final long serialVersionUID = -5539422250920232971L;
	private static final Logger logger = Logger.getLogger(ParamChkDisableAction.class);
	...
	public String execute() throws Exception {
		try{
			...
			{ 
				...
				ParamCheckingAc entity =  paramsCheckingAcService.getParamCheckingAcByUniqueComposite(tenantId, moduleCode, productCode, branch,effFromDate);
				if(null != entity){
